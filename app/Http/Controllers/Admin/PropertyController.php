...
class PropertyController extends Controller
{
    ...
    {
        abort_if(Gate::denies('Truy cập bài đăng'), Response::HTTP_FORBIDDEN, '403 Forbidden');
    ...
    {
        abort_if(Gate::denies('Tạo bài đăng'), Response::HTTP_FORBIDDEN, '403 Forbidden');
    ...
    {
         abort_if(Gate::denies('Sửa bài đăng'), Response::HTTP_FORBIDDEN, '403 Forbidden');
    ...
    {
        abort_if(Gate::denies('Xóa bài đăng'), Response::HTTP_FORBIDDEN, '403 Forbidden');
